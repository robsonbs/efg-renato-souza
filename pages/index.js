    ...
    <>
      ...
      <section className={styles.section}>
        <article>
          ...
          <span>
            O curso técnico de ensino médio em ciência de dados tem como
            objetivo formar profissionais capazes de coletar, organizar,
            analisar e interpretar dados, utilizando ferramentas e técnicas de
            estatística, matemática e computação. O curso tem duração de 3 anos
            e é oferecido na modalidade presencial. O curso é dividido em 3
            módulos, cada módulo tem duração de 1 ano. O curso é oferecido no
            período noturno.
          </span>
        ...
        <article>
          <h2>UX/UI</h2>
          <span>
            Design de interfaces e experiências de usuário, focando na
