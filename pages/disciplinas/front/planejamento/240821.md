...
Conceito de Tipos de variáveis em JavaScript - String (continuação)

# Objetivo

Desenvolver páginas web adicionando JS utilizando variáveis contendo textos usando aspas simples, duplas e interpolação
